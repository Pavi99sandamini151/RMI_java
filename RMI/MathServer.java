...
public class MathServer extends UnicastRemoteObject implements MathService {
    ...
    // I added the count finction to count the clients using ClientCount variable

    // and to make the thread safe I used the synchronized keyword to the method
    public synchronized int count() throws RemoteException {
        ClientCount++;
